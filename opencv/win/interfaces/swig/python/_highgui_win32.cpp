...
SWIG_Python_ConvertFunctionPtr(PyObject *obj, void **ptr, swig_type_info *ty) {
  if (!PyCFunction_Check(obj)) {
    ...
    const char *doc = (char*)(((PyCFunctionObject *)obj) -> m_ml -> ml_doc);
...
SWIGINTERN int
SWIG_AsVal_unsigned_SS_long_SS_long (PyObject *obj, uint64 *val)
{
  int res = SWIG_TypeError;
  if (PyLong_Check(obj)) {
...
static swig_type_info _swigt__p_long_long = {"_p_long_long", "int64 *|int64 *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_unsigned_long_long = {"_p_unsigned_long_long", "uint64 *|uint64 *|CvRNG *", 0, 0, (void*)0, 0};
...
#define SWIG_InstallConstants(d, constants)           SWIG_Python_InstallConstants(d, constants)
  ...
  SWIG_Python_FixMethods(PyMethodDef *methods,
    ...
    for (i = 0; methods[i].ml_name; ++i) {
      const char *c = (char*)methods[i].ml_doc;
